...
public class SpecDimensionEntity {
    ...
    @Column(name = "affects_appearance", nullable = false)
    private Boolean affectsAppearance;
    ...
    public Boolean getAffectsAppearance() {
        return affectsAppearance;
    }

    public void setAffectsAppearance(Boolean affectsAppearance) {
