...
public class SpecOption {
    ...
    /** 新建（尚未持久化，id 为 null） */
    public SpecOption(Long specDimensionId, String optionValue, Integer sortOrder, String image) {
        this.id = null;
    ...
    /** 从持久化还原 */
    public SpecOption(Long id, Long specDimensionId, String optionValue, Integer sortOrder, String image) {
