...
@RestControllerAdvice(basePackageClasses = { CategoryController.class, ProductController.class, ProductImageController.class, SpecDimensionController.class, SkuController.class, SkuLookupController.class, ServiceBindingController.class, EngravingPatternController.class })
