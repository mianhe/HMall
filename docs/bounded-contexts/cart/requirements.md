...
| 2 | 同一 SKU 去重，重复添加累加数量 | 电商通用体验，避免购物车内出现重复行 |
...
|------|----------------|------|-------------|
| 1. 添加商品到购物车 | cart-add-item.feature | 🔲 待实现 | 5 |
| 2. 查看购物车 | cart-query.feature | 🔲 待实现 | 3 |
| 3. 修改购物车项 | cart-update-item.feature | 🔲 待实现 | 4 |
| 4. 删除购物车项 | cart-delete-item.feature | 🔲 待实现 | 3 |
| 5. 购物车结算预览 | cart-checkout.feature | 🔲 待实现 | 2 |
