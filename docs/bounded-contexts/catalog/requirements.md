...
每个功能对应一个 .feature 文件，场景对应 Gherkin Scenario。契约：`docs/bounded-contexts/catalog/api.yaml`。Feature 目录：`backend/src/test/resources/features/catalog/`。
...
|------|----------------|--------|------|
| 1. 管理类目 | category.feature | 1.1～1.9 | ✅ 全部已实现 |
| 2. 管理商品 | product.feature | 2.1～2.9 | ✅ 全部已实现 |
| 3. 管理 SPU 规格维度与选项 | spec-dimension.feature | 3.1～3.9 | ✅ 全部已实现 |
